...
('ah-2','labeltitle','{"title":"📋 What\'\'s Included"}'::jsonb),
('ah-2','boxtitle','{"options":[{"label":"ETA","value":"1-3 business days"},{"label":"Includes","value":"All achievements + bonus content"},{"label":"Support","value":"24/7 live chat"}]}'::jsonb),
